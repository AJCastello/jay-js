...
export function generateGitIgnoreFileContent(): string {
  return "node_modules\ndist";
}

export function generateViteTypesFileContent(): string {
  return `/// <reference types="vite/client" />`;
}

export function generateNpmrFileContent(): string {
  return "enable-pre-post-scripts=true";
}

export function generateLogoSVGFileContent(): string {
