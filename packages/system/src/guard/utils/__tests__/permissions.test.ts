...
describe("permission utilities", () => {
	...
	describe("createPermission", () => {
		...
		test("should handle array inputs", () => {
			const permission = createPermission(["admin", "editor"], ["articles", "posts"], ["read", "write"], true);
		...
		test("should include attributes when provided", () => {
			const permission = createPermission("user", "profile", "edit", true, ["own"]);
		...
		test("should handle array of attributes", () => {
			const permission = createPermission("moderator", "comments", "moderate", true, ["reported", "flagged"]);
