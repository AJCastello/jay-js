...
export class EditorIntegration {
	...
	static async openFile(
		...
		try {
			const editorConfig = EditorIntegration.supportedEditors[editor as keyof typeof this.supportedEditors];
	...
	static async detectAvailableEditors(): Promise<string[]> {
		...
		for (const [name, config] of Object.entries(EditorIntegration.supportedEditors)) {
			try {
