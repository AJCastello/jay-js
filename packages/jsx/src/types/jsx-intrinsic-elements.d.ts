/**
 * @file JSX Intrinsic Elements Type Definitions
 * @description Shared type definitions for all standard HTML elements in JSX
 * This file is used by both production and development JSX runtimes
 */
