import { Link, List, Section, Typography } from "@jay-js/elements";
...
function TopicsItem(item: TOnThisPageListItem) {
	return Link({
		...
		className:
			"no-underline hover:text-primary text-xs p-2 hover:bg-base-200/50 border-l-2 border-transparent hover:border-primary hover:border-l-2 docs-article-topics",
	});
}
