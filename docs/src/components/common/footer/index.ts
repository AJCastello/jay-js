import { Box, Link, Section, Typography } from "@jay-js/ui";
import {
  FooterLogo,
  FooterNavItem,
  FooterLegalItem,
          ...
          Box({
            ...
            children: [
              ...
              Typography({
                ...
                children: intl("Jay JS is a lightweight and intuitive JavaScript framework for building modern web applications with minimal overhead. Build faster with a framework designed for simplicity and performance.")
              })
            ]
          }),
          Box({
