import { Box, Link, Section } from "@jay-js/ui";
...
export function NavBar() {
  return Section({
    tag: "nav",
    className: "w-full container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-0",
    children: [
      Box({
