...
export function UnleashPotential() {
	return Box({
		...
		children: [
			...
			Typography({
				children:
					"Explore our comprehensive documentation and dive into each Jay JS package to discover how it can revolutionize the way you build web applications. Get ready to experience a new level of performance, flexibility, and productivity.",
			}),
			Typography({
