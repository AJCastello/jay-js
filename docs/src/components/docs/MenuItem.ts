...
import { ICollectionArticle } from "../../types";
  ...
  return Box({
    children: [
      Link({
        ...
        className: "relative flex cursor-pointer items-center border-s-2 border-base-content/20 hover:border-primary py-1 ps-4 transition-colors duration-300 no-underline hover:text-primary text-sm",
        children: [
          Typography({
