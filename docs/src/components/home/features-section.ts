      ...
      Box({
        ...
        children: [
          ...
          Typography({
            ...
            children: "JayJS provides a complete toolkit for modern web development without unnecessary complexity or bloat."
          })
        ]
      }),
      Box({
        ...
        children: featuresList.map(({ title, description, icon }) => {
          return Box({
            className: "p-6 border border-base-300 rounded-lg shadow-sm transition-all duration-200 hover:shadow-md hover:border-primary/50",
            children: [
              Box({
