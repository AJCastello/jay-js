import { Box, Link, Img, Section, Typography } from "@jay-js/ui";
          ...
          Box({
            ...
            children: [
              ...
              Typography({
                ...
                children: "Build modern web applications with a framework that prioritizes simplicity and performance. JayJS combines the best of both worlds: intuitive APIs with minimal overhead."
              }),
              Box({
