import { Box, Icon, Img, Section, Typography } from "@jay-js/ui";
          ...
          Box({
            ...
            children: [
              ...
              Typography({
                ...
                children: "JayJS strikes the perfect balance between simplicity and capability, letting you build complex applications without complex tooling."
              }),
              Box({
